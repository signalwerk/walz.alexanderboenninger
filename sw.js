...
self.__precacheManifest = [
  {
    "url": "webpack-runtime-260aca6e7a5ded64857e.js"
  },
  {
    "url": "app.9ebab7bbdf9eda7594cd.css"
  },
  {
    "url": "app-5d23008624f6368e8c3b.js"
  },
  {
    "url": "component---node-modules-gatsby-plugin-offline-app-shell-js-5bc469de690d80d21ac7.js"
  },
  {
    "url": "offline-plugin-app-shell-fallback/index.html",
    "revision": "8dceb6ce548b58509b69e6264f98ef2e"
  },
  {
    "url": "component---src-pages-404-js-1854a650e8530e23ab82.js"
  },
  {
...
var navigationRoute = new workbox.routing.NavigationRoute(function (_ref) {
  ...
  return idbKeyval.get(WHITELIST_KEY).then(function (customWhitelist) {
    ...
    if (customWhitelist.includes(pathname)) {
      var offlineShell = "/walz.alexanderboenninger/offline-plugin-app-shell-fallback/index.html";
...
var messageApi = {
  whitelistPathnames: function whitelistPathnames(event) {
    ...
    pathnames = pathnames.map(function (_ref3) {
      ...
      if (!includesPrefix) {
        return "/walz.alexanderboenninger" + pathname;
      } else {
        return pathname;
      }
    });
